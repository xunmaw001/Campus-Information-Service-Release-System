  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='学校' prop="school">
               <el-input v-model="ruleForm.school"  placeholder='学校' clearable></el-input>
           </el-form-item>
         </el-col>
...
// 注册表 用户 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.school)&& 'yonghu'==this.flag){
