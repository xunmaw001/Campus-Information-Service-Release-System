...
import center from '@/views/center'
    ...
    import xinxiCollection from '@/views/modules/xinxiCollection/list'
    import xinxiLiuyan from '@/views/modules/xinxiLiuyan/list'
    ...
    import dictionaryXinxiCollection from '@/views/modules/dictionaryXinxiCollection/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryXinxiCollection',
        name: '收藏表类型',
        component: dictionaryXinxiCollection
    }
    ,{
        path: '/config',
        name: '轮播图',
    ...
    ,{
        path: '/xinxiCollection',
        name: '信息收藏',
        component: xinxiCollection
      }
    ,{
        path: '/xinxiLiuyan',
        name: '信息留言',
        component: xinxiLiuyan
      }
    ,{
        path: '/yonghu',
        name: '用户',
