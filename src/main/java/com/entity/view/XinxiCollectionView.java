...
public class XinxiCollectionView extends XinxiCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String xinxiCollectionValue;
	...
	public XinxiCollectionView() {

	}

	public XinxiCollectionView(XinxiCollectionEntity xinxiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, xinxiCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getXinxiCollectionValue() {
				return xinxiCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setXinxiCollectionValue(String xinxiCollectionValue) {
				this.xinxiCollectionValue = xinxiCollectionValue;
			}
